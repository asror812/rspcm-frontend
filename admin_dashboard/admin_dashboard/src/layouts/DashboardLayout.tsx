...
const navigationItems = [
  ...
  { title: "Teachers", icon: GraduationCap, path: "/dashboard/teachers" },
  { title: "Groups", icon: UsersRound, path: "/dashboard/groups" },
  { title: "Practices", icon: BookOpen, path: "/dashboard/practices" },
          ...
          <div className={cn("flex items-center gap-3", !sidebarOpen && "justify-center")}>
            ...
            {sidebarOpen && (
              <div className="flex-1 animate-fade-in">
                ...
                <p className="text-xs text-muted-foreground">admin@rspcm.edu</p>
              </div>
            )}
            {sidebarOpen && (
              <Button
